...
MIN_TL_XH_3000_10000_V201 = {
    ...
    'holding_registers': {
        ...
        3018: {'name': 'tl_xh_priority_mode', 'scale': 1, 'unit': '', 'access': 'R',
               'values': {0: 'Load First', 2: 'Battery First', 3: 'Grid First'},
               'desc': 'Read-back work mode / priority mode for MIN TL-XH'},
        ...
        30404: {'name': 'vpp_charge_cutoff_soc', 'scale': 1, 'unit': '%', 'access': 'RW',
                'valid_range': (70, 100), 'desc': 'VPP charging cut-off SOC'},
        30405: {'name': 'vpp_discharge_cutoff_soc', 'scale': 1, 'unit': '%', 'access': 'RW',
                'valid_range': (10, 30), 'desc': 'VPP online discharge cut-off SOC'},
        30406: {'name': 'vpp_load_priority_discharge_cutoff_soc', 'scale': 1, 'unit': '%', 'access': 'RW',
